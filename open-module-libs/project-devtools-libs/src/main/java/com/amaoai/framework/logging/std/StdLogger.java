...
public class StdLogger implements Logger {
    ...
    public void info(String fmt, Object... args) {
        trace(IOUtils.stdout, "INFO", fmt, args);
    }

    @Override
    public void debug(String fmt, Object... args) {
        trace(IOUtils.stdout, "DEBUG", fmt, args);
    }

    @Override
    public void warn(String fmt, Object... args) {
        trace(IOUtils.stdout, "WARN", fmt, args);
    }

    @Override
    public void error(String fmt, Object... args) {
        trace(IOUtils.stderr, "ERROR", fmt, args);
    }

    @Override
    public void error(String fmt, Throwable e, Object... args) {
        trace(IOUtils.stderr, "ERROR", StringUtils.vfmt("{}\n{}", fmt, StringUtils.getStackTrace(e)),
                args);
    }
