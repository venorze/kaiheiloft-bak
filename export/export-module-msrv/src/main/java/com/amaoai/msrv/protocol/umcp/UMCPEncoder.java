 ...
 * @author Amaoai
 */
public class UMCPEncoder extends MessageToByteEncoder<UMCProtocol> {
     ...
     */
    @Override
    protected void encode(ChannelHandlerContext channelHandlerContext, UMCProtocol umcp, ByteBuf byteBuf)
            throws Exception {
